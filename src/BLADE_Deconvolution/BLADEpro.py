    ...
    def wrapped(*args, **kwargs):
        ...
        try:
            ...
            with profile(activities=activities,
                         ...
                         with_stack=PROF_WITH_STACK) as prof:
                out = fn(*args, **kwargs)
...
def grad_Omega_C(Y, SigmaY, Nu, Omega, Beta, Mu0, Alpha0, Beta0, Kappa0, Ngene, Ncell, Nsample, weight):
    ...
    g_Var_main = 2.0 * Omega.unsqueeze(2) * first_term_permuted \
                 - 1.0 * Omega.unsqueeze(2) * second_term_permuted      # (G,C,S)
    ...
    def Optimize(self, steps=60, lr=2e-2, method="lbfgs", grad_clip=1e4, **opt_kwargs):
        ...
        def closure():
            ...
            if not torch.isfinite(obj):
                ...
                return torch.tensor(
                    1e30, device=self.device, dtype=self.Nu.dtype
                )
